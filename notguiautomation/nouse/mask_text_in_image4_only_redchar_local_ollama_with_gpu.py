...
OUTPUT_DIR = APP_DIR / "masked_outputs_ollama_gpu"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Extract red text strings with Ollama, search them in images, and output mask/composited images (GPU-enabled).",
        formatter_class=argparse.RawTextHelpFormatter,
        epilog=(
            "Examples:\n"
            "  python .\\notguiautomation\\mask_text_in_image4_only_redchar_local_ollama_with_gpu.py .\\masked_test\n"
            "  python .\\notguiautomation\\mask_text_in_image4_only_redchar_local_ollama_with_gpu.py .\\masked_test --output-dir .\\masked_outputs_ollama_gpu"
        ),
    )
